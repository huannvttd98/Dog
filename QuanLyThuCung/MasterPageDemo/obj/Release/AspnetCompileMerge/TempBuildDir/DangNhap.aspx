...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Đăng nhập - GIAYTOT.VN</title>
    <link href="Style/StyleDangNhap.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content">
<%--        <table class="tblForm" style="width: 800px;">
            <tr>
                <td>
                    Tên đăng nhập<asp:TextBox ID="txtUsername" runat="server"  CssClass="input"></asp:TextBox>
                    <br />
                    Mật khẩu<asp:TextBox ID="txtPassword" runat="server" TextMode="Password" CssClass="input"></asp:TextBox>
                    <br />
                    <asp:Button ID="btnDangNhap" runat="server" OnClick="btnDangNhap_Click" Text="Đăng Nhập" />
                </td>
                <td>
                    <p>BẠN CHƯA CÓ TÀI KHOẢN??</p>
                    <input type="button" value="ĐĂNG KÝ EM EI">
                </td>
            </tr>
        </table>--%>
        <table>
